...
(nextval('profile_info_type_seq'), 'HEIGHT', '키', '키', 'BASIC', 2, 'CUSTOM', '📏', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'BODY', '체형', '체형', 'BASIC', 3, 'SINGLE', '🧍', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'MBTI', 'MBTI', 'MBTI', 'BASIC', 4, 'SINGLE', '🧠', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'RELIGION', '종교', '종교', 'BASIC', 5, 'SINGLE', '🙏🏼', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
