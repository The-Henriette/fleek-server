...
(nextval('profile_info_type_seq'), 'COLLEGE', '학교', '학교', 'BASIC', 3, 'CERTIFIED_VALUE', '🧑‍💻', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'OCCUPATION', '직업', '직업', 'BASIC', 4, 'CUSTOM', '🧑‍💼', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'HEIGHT', '키', '키', 'BASIC', 5, 'CUSTOM', '📏', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'BODY', '체형', '체형', 'BASIC', 6, 'SINGLE', '🧍', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'MBTI', 'MBTI', 'MBTI', 'BASIC', 7, 'SINGLE', '🧠', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
(nextval('profile_info_type_seq'), 'RELIGION', '종교', '종교', 'BASIC', 8, 'SINGLE', '🙏🏼', EXTRACT(EPOCH FROM NOW()) * 1000, EXTRACT(EPOCH FROM NOW()) * 1000),
